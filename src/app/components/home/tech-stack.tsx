        ...
        <>
            <div className="w-full px-4 flex flex-wrap justify-center mt-8">
                <SiNextdotjs
                    ...
                    className="sm:py-8 sm:mt-8 hover:animate-pulse text-3xl sm:text-4xl mx-2 text-zinc-500 hover:text-zinc-300 cursor-pointer"
                />
                <FaReact
                ...
                <SiRoblox
                    ...
                    data-tooltip-place="bottom"
                    className="sm:py-8 sm:mt-8 hover:animate-pulse text-3xl sm:text-4xl ml-2 mr-6 sm:mr-12 text-zinc-500 hover:text-zinc-300 cursor-pointer"
                />
                <SiOpenai
